...
local ActionBars = function(self)
	...
	Window:CreateSwitch("ActionBars", "BottomLeftBar", "Enable action bar 2")
	Window:CreateSwitch("ActionBars", "BottomRightBar", "Enable action bar 3")
	Window:CreateSwitch("ActionBars", "RightBar", "Enable action bar 4")
	Window:CreateSwitch("ActionBars", "LeftBar", "Enable action bar 5")
